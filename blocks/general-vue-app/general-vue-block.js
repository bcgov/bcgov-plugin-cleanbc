    ...
    render() {
        ...
        return createElement(
            ...
            createElement(
                ...
                createElement(
                    PanelBody,
                    { title: 'VueJS App App Settings', initialOpen: true },
            ...
            createElement('div', { id: 'app', class: className, 'data-columns': columns }, 'VueJS App Placeholder')
        );
    }
}

registerBlockType('bcgov-block-theme-plugin/vuejs-wordpress-block', {
    title: 'General VueJS App',
    icon: 'format-image',
    category: 'common',
    attributes: {
        className: {
    ...
    save: ({ attributes }) => {
        ...
        return createElement('div', { id: 'app', class: className, 'data-columns': columns }, 'Loading VueJS App...');
    },
});
