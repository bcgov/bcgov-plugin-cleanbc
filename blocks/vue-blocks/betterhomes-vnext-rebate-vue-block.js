...
class BetterHomesvNextRebateVueAppEditorComponent extends wp.element.Component {
    constructor() {
        super(...arguments);
        this.state = {
            postTypes: [],
            ...
            createElement(
                ...
                createElement(
                    ...
                    createElement(SelectControl, {
                        ...
                        value: mode,
                        options: [
                            { label: 'Archive (show results)', value: 'archive' },
                            { label: 'Single (do not show results)', value: 'single' },
                        ],
                        onChange: (newVal) => setAttributes({ mode: newVal }),
                    })
                )
            ),
            createElement('div', {
                ...
                `vNext Rebate Filter Block Placeholder (${mode})`,
            ])
        );
    }
}

registerBlockType('cleanbc-plugin/betterhomes-vnext-rebate-filter-block', {
