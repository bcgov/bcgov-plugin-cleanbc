          ...
          if (event.type === "click" || event.type === "keypress" && event.key === "Enter") {
            ...
            if (cachedData) {
              ...
              try {
                ...
                console.error("Error fetching content:", error2);
              }
            }
          }
        }
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        sortedFilteredPosts.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_11$5, [
          ...
          _cache[1] || (_cache[1] = createTextVNode("Oops, no filterable results for ", -1)),
          createBaseVNode("strong", null, toDisplayString(filterPostTypeName.value), 1),
          _cache[2] || (_cache[2] = createTextVNode(" have been found. ", -1)),
          createBaseVNode("a", {
            href: "#",
            onClick: withModifiers(clearFilters, ["prevent"]),
            onKeydown: withKeys(withModifiers(clearFilters, ["prevent"]), ["enter"])
          }, "Try resetting your filters", 40, _hoisted_22$5),
          _cache[3] || (_cache[3] = createTextVNode(" and refining your selections.", -1))
        ]))
      ], 64);
    };
  }
  ...
  (function(t, e) {
    ...
    return (function() {
      var e = { 388: function(t2, e2) {
        ...
        (function(o, a) {
          ...
          function t3() {
            ...
            if (!e3 && "currentScript" in document && document.currentScript) return document.currentScript;
            if (e3 && e3.get !== t3 && document.currentScript) return document.currentScript;
            try {
              throw new Error();
            } catch (f) {
              ...
              for (var h2 = 0; h2 < d.length; h2++) {
                if ("interactive" === d[h2].readyState) return d[h2];
                if (d[h2].src === l) return d[h2];
                if (l === c && d[h2].innerHTML && d[h2].innerHTML.trim() === i3) return d[h2];
              }
              return null;
            }
          }
        ...
        if ("undefined" !== typeof DEBUG && DEBUG && !i2) throw new Error("vue-style-loader cannot be used in a non-browser environment. Use { target: 'node' } in your Webpack config to indicate a server-rendering environment.");
        ...
        function p2(t3, e3, r3, i3) {
          ...
          return m(a2), function(e4) {
            ...
            for (i4 = 0; i4 < r4.length; i4++) {
              l2 = r4[i4];
              if (0 === l2.refs) {
                for (var u2 = 0; u2 < l2.parts.length; u2++) l2.parts[u2]();
                delete o[l2.id];
              }
            }
          };
        ...
        function m(t3) {
          for (var e3 = 0; e3 < t3.length; e3++) {
            ...
            if (n3) {
              n3.refs++;
              for (var i3 = 0; i3 < n3.parts.length; i3++) n3.parts[i3](r3.parts[i3]);
              for (; i3 < r3.parts.length; i3++) n3.parts.push(y(r3.parts[i3]));
              n3.parts.length > r3.parts.length && (n3.parts.length = r3.parts.length);
            } else {
              var a2 = [];
              for (i3 = 0; i3 < r3.parts.length; i3++) a2.push(y(r3.parts[i3]));
        ...
        function y(t3) {
          ...
          } else n3 = v(), e3 = k.bind(null, n3), r3 = function() {
            n3.parentNode.removeChild(n3);
          };
          return e3(t3), function(n4) {
            if (n4) {
              if (n4.css === t3.css && n4.media === t3.media && n4.sourceMap === t3.sourceMap) return;
              e3(t3 = n4);
            } else r3();
          };
        }
        ...
        function k(t3, e3) {
          ...
          if (n3 && t3.setAttribute("media", n3), d.ssrId && t3.setAttribute(h2, e3.id), i3 && (r3 += "\n/*# sourceURL=" + i3.sources[0] + " */", r3 += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(i3)))) + " */"), t3.styleSheet) t3.styleSheet.cssText = r3;
          else {
      ...
      return (function() {
        ...
        function E(t3, e3, r3) {
          return e3 && D(t3.prototype, e3), Object.defineProperty(t3, "prototype", { writable: false }), t3;
        }
        function R(t3, e3, r3) {
          return e3 in t3 ? Object.defineProperty(t3, e3, { value: r3, enumerable: true, configurable: true, writable: true }) : t3[e3] = r3, t3;
        }
        ...
        function M(t3, e3) {
          ...
          if (null != r3) {
            ...
            try {
              for (r3 = r3.call(t3); !(a2 = (n2 = r3.next()).done); a2 = true) if (o2.push(n2.value), e3 && o2.length === e3) break;
            } catch (l2) {
              s2 = true, i2 = l2;
            } finally {
              try {
        ...
        function G(t3, e3, r3) {
          return e3 && W(t3.prototype, e3), Object.defineProperty(t3, "prototype", { writable: false }), t3;
        }
        function X(t3, e3, r3) {
          return e3 in t3 ? Object.defineProperty(t3, e3, { value: r3, enumerable: true, configurable: true, writable: true }) : t3[e3] = r3, t3;
        }
        ...
        var q = (A = {}, X(A, V.VALUE, 'The type of the "value" is illegal'), X(A, V.INTERVAL, 'The prop "interval" is invalid, "(max - min)" must be divisible by "interval"'), X(A, V.MIN, 'The "value" must be greater than or equal to the "min".'), X(A, V.MAX, 'The "value" must be less than or equal to the "max".'), X(A, V.ORDER, 'When "order" is false, the parameters "minRange", "maxRange", "fixed", "enabled" are invalid.'), A), Z = (function() {
          ...
          return G(t3, [{ key: "setValue", value: function(t4) {
            ...
            if (this.data) t4 = this.data.indexOf(t4);
              ...
              if (t4 = +t4, t4 < this.min) return this.emitError(V.MIN), 0;
              if (t4 > this.max) return this.emitError(V.MAX), 0;
              if ("number" !== typeof t4 || t4 !== t4) return this.emitError(V.VALUE), 0;
            ...
            for (var t4 = [], e3 = 0; e3 <= this.total; e3++) t4.push(new j(e3).multiply(this.interval).plus(this.min).toNumber());
            return t4;
        ...
        function J(t3, e3, r3) {
          return e3 && K(t3.prototype, e3), Object.defineProperty(t3, "prototype", { writable: false }), t3;
        }
        function Q(t3, e3, r3) {
          return e3 in t3 ? Object.defineProperty(t3, e3, { value: r3, enumerable: true, configurable: true, writable: true }) : t3[e3] = r3, t3;
        }
        ...
        var mt = { None: 0, Drag: 2, Focus: 4 }, vt = 4, yt = (0, o.defineComponent)({ name: "VueSlider", components: { VueSliderDot: m, VueSliderMark: k }, emits: ["change", "drag-start", "dragging", "drag-end", "error", "update:modelValue"], data: function() {
          ...
          if (!this.states.has(mt.Focus) || !this.$refs.container || this.$refs.container.contains(t3.target)) return false;
          ...
          var e3 = this;
          if (!this.useKeyboard || !this.states.has(mt.Focus)) return false;
...
const _hoisted_63$3 = ["tabindex", "onKeydown", "onFocus", "aria-label", "data-additional-info"];
const _hoisted_64$3 = { class: "ev-img" };
const _hoisted_65$3 = ["src", "alt"];
const _hoisted_66$3 = { style: { "margin-bottom": "1rem" } };
const _hoisted_67$3 = ["data-make"];
  ...
  setup(__props) {
    ...
    const getEVArray = () => {
      fetch(vehiclesAPI, { cache: "no-store" }).then((r) => r.json()).then((json) => {
        ...
        console.error("Error fetching vehicle data:", error2);
      });
    };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("h3", _hoisted_1$4, [
          _cache[20] || (_cache[20] = createTextVNode("Find a vehicle ", -1)),
          ...
          createBaseVNode("div", _hoisted_7$4, [
            createBaseVNode("div", _hoisted_8$4, [
                ...
                createBaseVNode("div", _hoisted_12$4, [
                  ...
                  createBaseVNode("details", _hoisted_15$4, [
                    createBaseVNode("summary", null, [
                      _cache[26] || (_cache[26] = createTextVNode("Price range as shown is based on automaker ", -1)),
                      createVNode(_component_nobr, null, {
                        default: withCtx(() => [..._cache[25] || (_cache[25] = [
                          createTextVNode("MSRP", -1),
                ...
                createBaseVNode("div", _hoisted_29$4, [
                  ...
                  createBaseVNode("p", _hoisted_30$4, [
                    vehicleTypes.value && vehicleTypes.value.includes("BEV") ? (openBlock(), createElementBlock("span", _hoisted_31$4, [..._cache[31] || (_cache[31] = [
                      ...
                      createTextVNode(" – Battery Electric Vehicle", -1),
                    ...
                    vehicleTypes.value && vehicleTypes.value.includes("ER-EV") ? (openBlock(), createElementBlock("span", _hoisted_32$4, [..._cache[32] || (_cache[32] = [
                      ...
                      createTextVNode(" – Extended Range EV", -1),
                      createBaseVNode("br", null, null, -1)
                    ])])) : createCommentVNode("", true),
                    vehicleTypes.value && vehicleTypes.value.includes("FCEV") ? (openBlock(), createElementBlock("span", _hoisted_33$4, [..._cache[33] || (_cache[33] = [
                      ...
                      createTextVNode(" – Fuel Cell Electric Vehicle", -1),
                      createBaseVNode("br", null, null, -1)
                    ])])) : createCommentVNode("", true),
                    vehicleTypes.value && vehicleTypes.value.includes("PHEV") ? (openBlock(), createElementBlock("span", _hoisted_34$4, [..._cache[34] || (_cache[34] = [
                      ...
                      createTextVNode(" – Plug-in Hybrid EV", -1),
                      createBaseVNode("br", null, null, -1)
                    ])])) : createCommentVNode("", true)
                  ])
                ])
              ...
              createBaseVNode("h4", _hoisted_35$4, [
                _cache[40] || (_cache[40] = createTextVNode("Available EV Types:", -1)),
            ...
            createBaseVNode("div", _hoisted_37$4, [
              ...
              createBaseVNode("h3", _hoisted_39$4, [
                _cache[44] || (_cache[44] = createTextVNode("Find a vehicle ", -1)),
              ...
              createBaseVNode("div", _hoisted_43$4, [
                createBaseVNode("div", _hoisted_44$4, [
                  ...
                  createBaseVNode("p", _hoisted_48$4, [
                    createBaseVNode("a", _hoisted_49$4, [
                      _cache[51] || (_cache[51] = createTextVNode("Price range as shown is based on automaker ", -1)),
                      createVNode(_component_nobr, null, {
                ...
                createBaseVNode("p", _hoisted_56$4, [
                  _cache[67] || (_cache[67] = createTextVNode("Available EV Types ", -1)),
                  ...
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", null, [
                      createBaseVNode("div", _hoisted_64$3, [
                        ...
                        }, null, 8, _hoisted_65$3)
                      ]),
                      createBaseVNode("p", _hoisted_66$3, [
                        createBaseVNode("span", {
                          class: "highlight vehicle-make-container",
                          "data-make": vehicle.make
                        }, toDisplayString(vehicle.make), 9, _hoisted_67$3),
                        ...
                        vehicle.maxMsrp === 0 ? (openBlock(), createElementBlock("span", {
                          ...
                          createBaseVNode("strong", null, [
                            _cache[71] || (_cache[71] = createTextVNode("MSRP", -1)),
                          ...
                          createBaseVNode("strong", null, [
                            _cache[72] || (_cache[72] = createTextVNode("MSRP", -1)),
                        ...
                        createBaseVNode("span", _hoisted_89, [
                          (openBlock(), createElementBlock("a", {
                            ...
                            _cache[76] || (_cache[76] = createTextVNode("Visit manufacturer website ", -1)),
                            createBaseVNode("span", {
                              "aria-hidden": "true",
...
const _hoisted_50$3 = ["href", "onClick", "aria-label"];
const _hoisted_51$3 = { key: 1 };
const _hoisted_52$3 = {
  key: 1,
  class: "pqea__service-organization-name--2"
};
const _hoisted_53$3 = ["href", "aria-label"];
const _hoisted_54$3 = { key: 1 };
const _hoisted_55$3 = ["href", "aria-label"];
const _hoisted_56$3 = { key: 1 };
const _hoisted_57$3 = {
  "data-label": "Program Qualified Services",
  class: "pqea__services"
};
const _hoisted_58$3 = { key: 0 };
const _hoisted_59$3 = { key: 0 };
const _hoisted_60$2 = {
  key: 0,
  class: "pqeasFilterControls filter-container filter-container--bottom"
};
const _hoisted_61$2 = { class: "pqeasFilterPagination control pagination pagination--bottom" };
const _hoisted_62$2 = ["disabled"];
const _hoisted_63$2 = { class: "pages" };
const _hoisted_64$2 = { class: "numValue current-page" };
const _hoisted_65$2 = { class: "numValue total-pages" };
const _hoisted_66$2 = ["disabled"];
const _hoisted_67$2 = ["disabled"];
const _sfc_main$3 = {
  __name: "pqeaVueApp",
  setup(__props) {
    var _a;
    ...
    const isQuotaExceededError = (error2) => {
      ...
      return error2.code === 22 || error2.code === 1014 || error2.name === "QuotaExceededError" || error2.name === "NS_ERROR_DOM_QUOTA_REACHED";
    };
    ...
    const fetchData2 = async () => {
      try {
        ...
        console.error("Error fetching pqeas data:", error2);
        throw error2;
      }
    };
    ...
    const onEmailPhoneClick = (pqea, linkType) => {
      ...
      let destination = "";
      if (linkType === "email") {
        pqea.email ? `Email: ${pqea.details.email}` : "Email link";
        destination = `mailto:${pqea.details.email}`;
      } else {
        pqea.phone ? `Phone: ${pqea.details.phone}` : "Phone link";
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1$3, [
              ...
              isVisible.value || 1 < totalPages.value && !isVisible.value ? (openBlock(), createElementBlock("div", _hoisted_2$3, [
                ...
                isVisible.value && 1 !== totalPages.value || 1 < totalPages.value && !isVisible.value ? (openBlock(), createElementBlock("div", _hoisted_14$3, [
                  ...
                  createBaseVNode("span", _hoisted_16$3, [
                    _cache[7] || (_cache[7] = createTextVNode("Page ", -1)),
                  ...
                  createBaseVNode("span", _hoisted_24$3, [
                    ...
                    createBaseVNode("span", _hoisted_28$3, [
                      _cache[14] || (_cache[14] = createTextVNode("Page ", -1)),
                      createBaseVNode("span", _hoisted_29$3, toDisplayString(currentPage.value), 1),
                      _cache[15] || (_cache[15] = createTextVNode(" of ", -1)),
          ...
          createBaseVNode("h2", _hoisted_31$3, [
            _cache[16] || (_cache[16] = createTextVNode("Find an Energy Advisor (", -1)),
            createBaseVNode("span", _hoisted_32$3, toDisplayString(filteredPqeas.value.length), 1),
            _cache[17] || (_cache[17] = createTextVNode(" results)", -1))
          ]),
              ...
              pqeas.value.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 2 }, renderList(paginatedPqeas.value, (pqea, index) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", _hoisted_47$3, [
                    pqea.details.service_organization_name || pqea.details.service_organization_name_2 ? (openBlock(), createElementBlock("ul", _hoisted_48$3, [
                      pqea.details.service_organization_name ? (openBlock(), createElementBlock("li", _hoisted_49$3, [
                        pqea.details.service_organization_website ? (openBlock(), createElementBlock("a", {
                          ...
                          target: "_blank",
                          onClick: ($event) => onProviderLinkClick(pqea),
                          "aria-label": pqea.details.service_organization_name + " website, opens in a new tab/window."
                        }, toDisplayString(pqea.details.service_organization_name), 9, _hoisted_50$3)) : (openBlock(), createElementBlock("span", _hoisted_51$3, toDisplayString(pqea.details.service_organization_name), 1))
                      ])) : createCommentVNode("", true),
                      pqea.details.service_organization_name_2 ? (openBlock(), createElementBlock("li", _hoisted_52$3, [
                        pqea.details.service_organization_website_2 ? (openBlock(), createElementBlock("a", {
                          ...
                          class: "external-app-link",
                          target: "_blank",
                          "aria-label": pqea.details.service_organization_name_2 + " website, opens in a new tab/window."
                        }, toDisplayString(pqea.details.service_organization_name_2), 9, _hoisted_53$3)) : (openBlock(), createElementBlock("span", _hoisted_54$3, toDisplayString(pqea.details.service_organization_name_2), 1))
                      ])) : createCommentVNode("", true),
                      pqea.details.additional_service_organizations ? (openBlock(true), createElementBlock(Fragment, { key: 2 }, renderList(pqea.details.additional_service_organizations, (org, index2) => {
                        return openBlock(), createElementBlock("li", { key: index2 }, [
                          org[1] ? (openBlock(), createElementBlock("a", {
                            ...
                            class: "external-app-link",
                            target: "_blank",
                            "aria-label": org[0] + " website, opens in a new tab/window."
                          }, toDisplayString(org[0]), 9, _hoisted_55$3)) : (openBlock(), createElementBlock("span", _hoisted_56$3, toDisplayString(org[0]), 1))
                        ]);
                      }), 128)) : createCommentVNode("", true)
                    ])) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("td", _hoisted_57$3, [
                    pqea.services ? (openBlock(), createElementBlock("p", _hoisted_58$3, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(pqea.services, (service, services_index) => {
                        return openBlock(), createElementBlock("span", {
                          ...
                          services_index != Object.keys(pqea.services).length - 1 ? (openBlock(), createElementBlock("span", _hoisted_59$3, ", ")) : createCommentVNode("", true)
                        ], 2);
                      }), 256))
                    ])) : createCommentVNode("", true)
                  ])
        ...
        filteredPqeas.value.length !== 0 && 1 !== totalPages.value ? (openBlock(), createElementBlock("div", _hoisted_60$2, [
          createBaseVNode("div", _hoisted_61$2, [
            createBaseVNode("button", {
              ...
              tabindex: "0",
              type: "button"
            }, "Previous Page", 8, _hoisted_62$2),
            createBaseVNode("span", _hoisted_63$2, [
              _cache[25] || (_cache[25] = createTextVNode("Page ", -1)),
              createBaseVNode("span", _hoisted_64$2, toDisplayString(currentPage.value), 1),
              _cache[26] || (_cache[26] = createTextVNode(" of ", -1)),
              createBaseVNode("span", _hoisted_65$2, toDisplayString(totalPages.value), 1)
            ]),
            createBaseVNode("button", {
              class: "next-page",
              onClick: withModifiers(nextPage, ["prevent"]),
            ...
            }, "Go to top of results", 8, _hoisted_67$2)
          ])
        ])) : createCommentVNode("", true)
      ], 64);
    };
...
const PQEAFilterApp = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-eb0020c1"]]);
  ...
  setup(__props) {
    ...
    const fetchData2 = async () => {
      try {
        ...
        console.error("Error fetching contractors data:", error2);
        throw error2;
      }
    };
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1$2, [
          ...
          isVisible.value || 1 < totalPages.value && !isVisible.value ? (openBlock(), createElementBlock("div", _hoisted_2$2, [
            ...
            isVisible.value && 1 !== totalPages.value || 1 < totalPages.value && !isVisible.value ? (openBlock(), createElementBlock("div", _hoisted_16$2, [
              ...
              createBaseVNode("span", _hoisted_18$2, [
                _cache[11] || (_cache[11] = createTextVNode("Page ", -1)),
                createBaseVNode("span", _hoisted_19$2, toDisplayString(currentPage.value), 1),
                _cache[12] || (_cache[12] = createTextVNode(" of ", -1)),
              ...
              createBaseVNode("span", _hoisted_26$2, [
                ...
                createBaseVNode("span", _hoisted_30$2, [
                  _cache[18] || (_cache[18] = createTextVNode("Page ", -1)),
                  createBaseVNode("span", _hoisted_31$2, toDisplayString(currentPage.value), 1),
                  _cache[19] || (_cache[19] = createTextVNode(" of ", -1)),
          ...
          createBaseVNode("h2", _hoisted_33$2, [
            _cache[20] || (_cache[20] = createTextVNode("Find a registered contractor (", -1)),
            createBaseVNode("span", _hoisted_34$2, toDisplayString(filteredContractors.value.length), 1),
            _cache[21] || (_cache[21] = createTextVNode(" results)", -1))
          ]),
  ...
  setup(__props) {
    ...
    const fetchData2 = async () => {
      try {
        ...
        console.error("Error fetching rebates data:", error2);
        throw error2;
      }
    };
        ...
        createBaseVNode("div", _hoisted_2$1, [
          ...
          createBaseVNode("div", _hoisted_33$1, [
            ...
            createBaseVNode("span", _hoisted_35$1, [
              _cache[19] || (_cache[19] = createTextVNode("Page ", -1)),
              createBaseVNode("span", _hoisted_36$1, toDisplayString(currentPage.value), 1),
              _cache[20] || (_cache[20] = createTextVNode(" of ", -1)),
            ...
            createBaseVNode("span", _hoisted_39$1, [
              _cache[22] || (_cache[22] = createTextVNode(" Showing ", -1)),
              ...
              _cache[23] || (_cache[23] = createTextVNode(" Rebates ", -1))
            ]),
            createBaseVNode("span", _hoisted_43$1, [
              createBaseVNode("span", _hoisted_44$1, [
                _cache[24] || (_cache[24] = createTextVNode(" Showing ", -1)),
              ...
              createBaseVNode("span", _hoisted_47$1, [
                _cache[26] || (_cache[26] = createTextVNode("Page ", -1)),
                createBaseVNode("span", _hoisted_48$1, toDisplayString(currentPage.value), 1),
                _cache[27] || (_cache[27] = createTextVNode(" of ", -1)),
        ...
        createBaseVNode("div", _hoisted_50$1, [
          ...
          createBaseVNode("div", _hoisted_57$1, [
            createBaseVNode("h2", _hoisted_58$1, [
              _cache[31] || (_cache[31] = createTextVNode("Results (", -1)),
            ...
            isVisible.value && filteredRebates.value.length !== 0 && 1 !== totalPages.value ? (openBlock(), createElementBlock("div", _hoisted_68$1, [
              createBaseVNode("div", _hoisted_69$1, [
                ...
                createBaseVNode("span", _hoisted_71$1, [
                  _cache[35] || (_cache[35] = createTextVNode("Page ", -1)),
                  createBaseVNode("span", _hoisted_72$1, toDisplayString(currentPage.value), 1),
                  _cache[36] || (_cache[36] = createTextVNode(" of ", -1)),
  ...
  setup(__props) {
    ...
    const fetchData2 = async () => {
      try {
        ...
        console.error("Error fetching faqs data:", error2);
        throw error2;
      }
    };
                  ...
                  !isLoading.value && faqs.value ? (openBlock(), createElementBlock("fieldset", _hoisted_12, [
                    createBaseVNode("div", {
                      ...
                      createBaseVNode("label", _hoisted_14, [
                        _cache[8] || (_cache[8] = createTextVNode("Show All ", -1)),
          ...
          createBaseVNode("div", _hoisted_21, [
            isVisible.value && 1 !== totalPages.value || 1 < totalPages.value && !isVisible.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              ...
              createBaseVNode("span", _hoisted_23, [
                _cache[13] || (_cache[13] = createTextVNode("Page ", -1)),
                createBaseVNode("span", _hoisted_24, toDisplayString(currentPage.value), 1),
                _cache[14] || (_cache[14] = createTextVNode(" of ", -1)),
            ...
            createBaseVNode("span", _hoisted_27, [
              ...
              _cache[17] || (_cache[17] = createTextVNode(" Frequently Asked Questions ", -1))
            ]),
            createBaseVNode("span", _hoisted_31, [
              createBaseVNode("span", _hoisted_32, [
                _cache[18] || (_cache[18] = createTextVNode("Showing ", -1)),
              ...
              createBaseVNode("span", _hoisted_35, [
                _cache[20] || (_cache[20] = createTextVNode("Page ", -1)),
        ...
        createBaseVNode("div", _hoisted_38, [
              ...
              !isLoading.value && faqs.value ? (openBlock(), createElementBlock("fieldset", _hoisted_41, [
                ...
                createBaseVNode("div", {
                  ...
                  createBaseVNode("label", _hoisted_43, [
                    _cache[22] || (_cache[22] = createTextVNode("Show All ", -1)),
          ...
          createBaseVNode("div", _hoisted_46, [
            createBaseVNode("h2", _hoisted_47, [
              _cache[27] || (_cache[27] = createTextVNode("Results (", -1)),
