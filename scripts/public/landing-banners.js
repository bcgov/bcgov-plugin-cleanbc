...
const bcgovBlockThemePlugin = {
    initFrontendLandingBanners: function () {
        /*
        ...
        */
        requestAnimationFrame(() => {
            ...
            if (isHomeBanner.length || isLandingBanner.length) {
                ...
                const clipElementDefs = document.createElementNS(svgNamespace, 'defs');
                const clipElementClipPath = document.createElementNS(svgNamespace, 'clipPath');
...
if ('complete' === document.readyState) {
    bcgovBlockThemePlugin.initFrontendLandingBanners();
} else {
    document.addEventListener('DOMContentLoaded', bcgovBlockThemePlugin.initFrontendLandingBanners());
}